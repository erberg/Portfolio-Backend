...
<script id="articleTemplate" type="text/template">
	<div class="container article-container">
		...
		<div class="two columns"><ul class="square"><%= tech_list %></div>
	</div><!-- container -->
</script>
...
<script id="articleTemplateAlt" type="text/template">
	<div class="container article-container">
		...
		<div class="five columns"><%= content %></div>
	...
	<div class="container article-container">
		...
		<div class="seven columns"><div class="article-image"><img src="/img/folio.jpg" alt="Artist Portfolio Website"/></div></div>
	...
	<div class="container article-container">
		...
		<div class="six columns"><div class="article-image"><img src="/img/blackjack.jpg" alt="Poker Cards and Chips"></div></div>
		...
		<div class="seven columns"><div class="article-image"><img src="/img/gameoflife.jpg" alt="Random Green Pixels"/></div></div>
	...
	<div class="container article-container">
		...
		<div class="six columns"><div class="article-image"><img src="/img/aura.jpg" alt="E-Commerce Site"/></div></div>
